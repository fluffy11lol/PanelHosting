...
const (
	...
	ProjectService_DeleteProject_FullMethodName = "/api.ProjectService/DeleteProject"
	ProjectService_ListProjects_FullMethodName  = "/api.ProjectService/ListProjects"
)
...
type ProjectServiceClient interface {
	...
	GetProject(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetProjectResponse, error)
...
func (c *projectServiceClient) GetProject(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetProjectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProjectServiceServer interface {
	...
	GetProject(context.Context, *emptypb.Empty) (*GetProjectResponse, error)
...
func (UnimplementedProjectServiceServer) GetProject(context.Context, *emptypb.Empty) (*GetProjectResponse, error) {
...
func _ProjectService_GetProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).GetProject(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
